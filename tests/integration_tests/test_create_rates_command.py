...
@pytest.fixture()
def insert_agency() -> TestRepository[Agency]:
    repo = TestRepository[Agency]()
...
def test_rates_can_be_created_from_command_handler(insert_agency: TestRepository[Agency]) -> None:
    # Arrange
